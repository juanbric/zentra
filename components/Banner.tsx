      ...
      <div className="px-4 lg:px-8 w-auto lg:w-[1130px]">
        <section className="">
          <div className="md:grid md:grid-cols-2 md:gap-[80px]">
            <div className="py-[52px] md:py-[138px]">
            ...
            <div className="hidden md:mt-0 md:flex pb-[52px] max-w-[381px] md:py-[138px] md:pb-0 relative">
              <img src="/white.png" className="ml-12 rounded-[1000px] max-w-[381px] h-[381px]" />
              <img src="/blue.png" className="rounded-[1000px] w-[381px] h-[381px] z-10 absolute md:top-[87px] md:left-[155px]" />
            </div>
          </div>
        </section>
      </div>
