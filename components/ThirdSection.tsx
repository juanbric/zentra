  ...
  return (
    <div className="lg:flex lg:justify-center lg:items-center">
      <div className="px-4 lg:px-8 w-auto lg:w-[1130px]">
        <section className="pt-[42px] pb-8 md:pt-[178px] md:pb-[78px] flex flex-col items-center justify-center">
          <div className="max-w-[911px] md:text-center">
            <p className="title pb-4">Soluciones tecnológicas eficientes.</p>
            <h2 className="sub-title mb-[32px] md:mb-[62px]">{platformHighlights}</h2>
          </div>
          <div className="md:grid md:grid-cols-3 md:gap-16">
            <div className="text-center flex flex-col max-w-[250px] md:max-w-[370px]"> 
